...
if __name__ == "__main__":
    ...
    prc_df = zp.mk_prc_df(tickers_list, 'adj_close')
    stock_returns_df = zp.mk_ret_df(prc_df)
    ticker_result = part1(stock_returns_df)
    part2_result = part2(stock_returns_df)
    part3_result = part3(stock_returns_df, ticker_result)
    part4_result = part4(stock_returns_df, ticker_result)
